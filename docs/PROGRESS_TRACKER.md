...
| R2 MatchWorld ownership | `.scratch/roadmap/issues/01-runtime-compatibility-gates.md` | Continue after round/target/pause/env-shake/audio/envcolor ownership; next proof should target combat/effect ordering, deeper audio/presentation semantics, or exact checksum-stable ownership. |
