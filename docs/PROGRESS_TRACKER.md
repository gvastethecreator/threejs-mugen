...
| --- | --- | --- |
| Runtime | `pnpm qa:trace` required artifacts, native/generated roster, imported KFM optional fixtures. Latest runtime aggregate: 150/150 artifacts passed, 132 required and 18 optional. Latest new required oracle: `synthetic-imported-modifyexplod.json` checksum `bca75991`. | Exact controller/VM tick order inside frames, helpers as real VM actors, custom states/throws, teams, full guard/fall/recovery semantics and exact FightFX/sound timing. |
