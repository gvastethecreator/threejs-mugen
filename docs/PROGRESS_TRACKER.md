...
Docs/setup work alone does not change scores. This guard-hit trace-strengthening cut also keeps current score bands unchanged because it tightens existing required evidence without broadening runtime parity claims.
