...
| --- | --- | --- |
| R1 KFM/Common1 recovery precision | `.scratch/roadmap/issues/01-runtime-compatibility-gates.md` | Next proof should move beyond threshold plus bounded ground-selection/velocity into exact tick-order, optional KFM threshold oracle, or broader guard/Common1 parity. |
