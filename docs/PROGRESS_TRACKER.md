...
| R2 MatchWorld ownership | `.scratch/roadmap/issues/01-runtime-compatibility-gates.md` | Continue after round/target/pause/env-shake/audio/envcolor/sprite-effect/actor-constraint/direct-combat/hitoverride ownership; next proof should target remaining combat/effect ordering, ReversalDef ownership, deeper presentation semantics, helper/projectile/explod ownership, or exact checksum-stable ownership. |
