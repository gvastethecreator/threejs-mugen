...
| Combat/Common1 | 30 | Direct HitDef, guard, hitstun, fall/get-hit/recovery gates, bounded hit/guard-sound and hit/guard-spark telemetry plus smoke-gated player AIR spark sprite rendering/source metadata. | Exact guard/fall/recovery, custom states, throws, priority, KO/round flow. |
