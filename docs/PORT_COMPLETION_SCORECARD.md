...
| Combat/Common1 | 30 | Direct HitDef, guard, hitstun, fall/get-hit/recovery gates, bounded guard-sound and hit/guard-spark telemetry. | Exact guard/fall/recovery, custom states, throws, priority, KO/round flow. |
...
| Stages/presentation/audio | 25 | Basic imported stage route, EnvShake/EnvColor, partial SND event path, bounded HitDef guard sound plus hit/guard spark telemetry. | BGCtrl parity, screenpacks/lifebars, FightFX, audio mixing/timing. |
