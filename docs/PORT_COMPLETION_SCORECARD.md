...
2. Exact-enough fall/recovery velocities, ground/air recovery selection, and optional fixture threshold oracles beyond the current synthetic threshold handoff plus synthetic/official early recovery-input reject gates.
