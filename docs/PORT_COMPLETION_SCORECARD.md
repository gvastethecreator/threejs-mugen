...
| Combat/Common1 | 30 | Direct HitDef, guard, hitstun, fall/get-hit/recovery gates, bounded guard-sound and hit/guard-spark telemetry plus smoke-gated fallback spark rendering. | Exact guard/fall/recovery, custom states, throws, priority, KO/round flow. |
...
| Stages/presentation/audio | 25 | Basic imported stage route, EnvShake/EnvColor, partial SND event path, bounded HitDef guard sound plus hit/guard spark telemetry and 120-frame fallback Three.js spark overlay. | BGCtrl parity, screenpacks/lifebars, FightFX/common assets, audio mixing/timing. |
