...
3. R1 presentation: deepen FightFX/common spark presentation beyond first-pass package `fight.def`/AIR/SFF loading, decoded system-SFF provider registration, and bounded AIR-duration frame advance: exact binding, layering, scale, palette, and motif/screenpack ownership remain open.
