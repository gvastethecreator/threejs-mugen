...
3. R1 presentation: extend bounded system-namespace spark lookup into package-backed common/default and FightFX action/SFF lookup gates, keeping fallback geometry as the failure path.
