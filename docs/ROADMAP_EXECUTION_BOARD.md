...
- Current proof: required `synthetic-imported-common-gethit.json` checksum `713e49b7` now gates bounded P2 FallEnvShake runtime event telemetry for state `5100` in addition to `HitFallVel`, `HitFallDamage`, `HitFallSet`, and `fallenvshake` typed-operation evidence.
