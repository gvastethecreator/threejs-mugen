...
3. R1 presentation: wire real fight.def/FightFX/common AIR/SFF loading and decoded system-SFF provider registration into the package-frame HitSpark handoff, keeping fallback geometry as the failure path.
