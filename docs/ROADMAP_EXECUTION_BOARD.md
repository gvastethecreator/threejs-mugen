...
3. R1 presentation: extend the new player AIR spark frame lookup into common/default and FightFX asset lookup gates, keeping fallback geometry as the failure path.
