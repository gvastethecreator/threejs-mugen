...
3. R1 presentation: replace current spark source classification with first real FightFX/common asset lookup gate, keeping fallback geometry as the failure path.
