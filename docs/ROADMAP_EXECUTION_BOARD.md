...
- Current proof: required `synthetic-imported-target.json` checksum `f5a16dc9` gates bounded TargetLifeAdd/TargetPowerAdd/TargetVel*/TargetFacing/TargetBind/BindToTarget/TargetDrop side effects through typed operations, target-link/binding evidence, P2 facing/velocity actor-frame evidence, final P1 `targetCount = 0`, and final P2 `life = 943` / `power = 40`.
