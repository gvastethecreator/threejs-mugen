...
| `ikemen-go` | Explicit IKEMEN-GO runtime policy selection. | Executed Partial for named, source-backed slices only. | Root/helper actor RunOrder plus same-tick appended-helper execution; no general IKEMEN content execution claim. |
