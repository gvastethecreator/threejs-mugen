...
- synthetic bounded player-owned and helper-parented/root-owned Projectile 640x480 character `localcoord` omitted default bounds terminal playback through `synthetic-imported-projectile-localcoord-default-bounds-terminal.json` and `synthetic-imported-helper-projectile-localcoord-default-bounds-terminal.json`
...
- Controller-param Root redirect through `synthetic-imported-controller-param-root-redirect.json`, helper-local controller-param Parent/Root redirect through `synthetic-imported-helper-controller-param-parentroot.json`, helper-local dynamic `VelAdd` Parent/Root redirect through `synthetic-imported-helper-dynamic-veladd.json`, helper-local dynamic `VelMul` Parent/Root redirect through `synthetic-imported-helper-dynamic-velmul.json`, helper-local dynamic `PosSet` Parent/Root redirect through `synthetic-imported-helper-dynamic-posset.json`, helper-local dynamic `PosAdd` Parent/Root redirect through `synthetic-imported-helper-dynamic-posadd.json`, Target redirect through `synthetic-imported-controller-param-target-redirect.json`, plus controller-param bottom fallback through `synthetic-imported-controller-param-bottom.json`
