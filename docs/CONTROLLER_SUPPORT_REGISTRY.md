...
| `CtrlSet`, `Turn` | executed-partial | unit tests/runtime traces | Runtime metadata/physics flags only; `CtrlSet` also lowers static numeric values into typed `resource:ctrlset` evidence. |
