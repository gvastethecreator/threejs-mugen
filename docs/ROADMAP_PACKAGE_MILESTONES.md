...
R2 helper-local micro-VM ownership
  ...
  -> no redirects, parent/root/team/keyctrl, helper life/power resources, VarRandom, helper audio/effects, helper-owned HitDefs/Projectiles/Explods, helper combat, exact tick-order/pause parity, full custom-state helper lifecycle, or score claim
