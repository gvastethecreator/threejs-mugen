...
S1 Studio CSS module split and shadow prune
  ...
  -> pnpm qa:css:budget now freezes current debt ceilings for CSS cleanup/review rounds: 2,669 rules, 173 repeated declaration groups, 126 cross-file overlaps, and zero exact/shadowed/src-style overlap regressions
