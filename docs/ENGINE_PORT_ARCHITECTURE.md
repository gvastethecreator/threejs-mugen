...
13. `HelperSystem`: own the current visual helper actor lifecycle, explicit owner-side removal, bounded helper-local state/action/kinematic/DestroySelf micro-VM, and snapshots.
