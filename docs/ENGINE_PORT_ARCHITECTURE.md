...
6. `SpriteEffectSystem`: own `SprPriority`, `PalFX`, `Trans`, `AfterImage`, and `AfterImageTime` parsing/ticking, while Three.js applies snapshot material changes.
