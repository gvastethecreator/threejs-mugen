...
- Measured evidence: [`docs/evidence/da29/measured/`](evidence/da29/measured/)
...
Empty after full DA29 series drain. Per-ID closeouts and measured evidence remain under `docs/evidence/da29/`.
