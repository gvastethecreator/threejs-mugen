...
2. Tighten official KFM/Common1 recovery after the current synthetic `5050 -> 5210 -> 0` recovery-input branch plus optional official `5110 -> 5120 -> 0`, `5050 -> 5210 -> 52 -> 0`, and `5050 -> 5200 -> 5201 -> 52 -> 0` fixture gates by adding exact recovery thresholds/velocities and exact tick-order checks.
...
1. Tighten official KFM/Common1 recovery with exact recovery thresholds/velocities and exact tick-order evidence after the current synthetic `5050 -> 5210 -> 0` recovery-input branch plus optional official `5110 -> 5120 -> 0`, `5050 -> 5210 -> 52 -> 0`, and `5050 -> 5200 -> 5201 -> 52 -> 0` fixture gates.
