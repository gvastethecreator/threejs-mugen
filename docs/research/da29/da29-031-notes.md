# DA29-031 research inventory

Wave 3

## Cut
Build a pinned Elecbyte controller census. Depends on DA29-016.

## Acceptance ceiling
Official controller names, parameters, defaults, profile/version, source locations, and unsupported notes are recorded without inferring implementation.

## Risk
Docs versions can differ. Allows source census only.
