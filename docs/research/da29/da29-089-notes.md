# DA29-089 research inventory

Wave 8

## Cut
Classify ZSS, Lua, and module findings by capability and risk. Depends on DA29-016 and DA29-087.

## Acceptance ceiling
Located report separates detected syntax, static metadata, blocked execution, sandbox needs, upstream profile, and explicit unsupported outcomes.

## Risk
Scanner recognition can imply execution. Allows recognition only.
