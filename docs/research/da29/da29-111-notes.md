# DA29-111 research inventory

Wave 11

## Cut
Inventory current user routes and viewport states. Depends on DA29-003.

## Acceptance ceiling
Route map covers first run, import, play, pause, inspect, Studio edit/save/reopen, evidence, build/export, errors, empty/loading, mobile/desktop, and ownership.

## Risk
Missing states hide UX debt. Allows inventory only.
