# DA29-191 research inventory

Wave 19

## Cut
Plan workspace/package splits from the proven dependency graph. Depends on DA29-133, DA29-140, and DA29-188.

## Acceptance ceiling
Proposal names packages, owners, public/private entrypoints, build order, browser/Node targets, dependency cycles, migration steps, and size/test impact.

## Risk
Package split can move coupling rather than remove it. Allows plan only.
