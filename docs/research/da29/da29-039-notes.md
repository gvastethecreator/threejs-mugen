# DA29-039 research inventory

Wave 3

## Cut
Rank the next controller families by lawful corpus demand and semantic risk. Depends on DA29-015 and DA29-038.

## Acceptance ceiling
Backlog ranks at least ten families by occurrences, routes, dependencies, failure cost, and source confidence; no controller is marked supported.

## Risk
Popularity may crowd out core rules. Allows priority order only.
