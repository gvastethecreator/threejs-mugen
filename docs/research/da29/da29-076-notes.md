# DA29-076 research inventory

Wave 7

## Cut
Reconcile FightScreen timing and transform ownership. Depends on DA29-016 and current T287/T288 work.

## Acceptance ceiling
Source/local map covers intro, shutter, round/fight/KO/win/time, motif transforms, dialogue, layer order, skip, reset, and open screenpack fields.

## Risk
UI shell can hide timing gaps. Allows design and priority only.
