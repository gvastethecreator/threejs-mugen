...
- Scanner refresh: 2026-07-02 adds report-only character `fightfx.prefix` recognition, source-mapped to the local Ikemen-GO `char.go` parser path. This still does not authorize character-specific FightFX prefix routing in runtime.
