...
R2 visual-helper removal ownership
  ...
  -> no redirects, parent/root/team ownership, helper Target* mutation/default-id target parity, helper custom-state targets, helper-owned Projectile combat/contact, exact helper HitDef lifetime/multi-hit parity, exact lifecycle tick-order parity, or score movement claim
