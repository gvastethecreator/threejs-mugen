...
R2 bounded helper-local NumExplod gate
  ...
  -> pnpm qa:trace now passes 176/176 artifacts, 156 required and 20 optional
...
R2 bounded helper-local ModifyExplod gate
  -> superseded by helper-local NumExplod gate; pnpm qa:trace now passes 176/176 artifacts, 156 required and 20 optional
...
R1 required combined hit/guard-effect contact-package trace strengthening
  ...
  -> current aggregate after the helper-local NumExplod gate is 176/176 artifacts, 156 required and 20 optional
