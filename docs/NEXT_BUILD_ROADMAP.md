...
R2 helper Target controller mutation gate
  ...
  -> current qa:trace aggregate is 198/198 artifacts, 178 required and 20 optional
  -> latest helper TargetState proof is required: synthetic-imported-helper-targetstate.json checksum 011633b8
...
R1 presentation spark-offset requirement gate
  ...
  -> affected behavior checksums remained stable at that checkpoint; current qa:trace aggregate after the helper TargetState gate is 198/198 artifacts, 178 required and 20 optional
  -> this narrows trace precision only; no exact renderer binding/timing/layering/scale/palette, SND playback, helper-owned presentation ownership, score movement, or full presentation parity claim
...
R1 required combined hit/guard-effect contact-package trace strengthening
  ...
  -> current aggregate after the helper TargetState gate is 198/198 artifacts, 178 required and 20 optional
