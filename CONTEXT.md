...
- Useful next runtime work remains another R1 Common1/FightFX precision cut or a deeper R2 helper/effect/combat ownership seam; do not reselect the just-closed official-style air-recovery gate, official-style ground-recovery gate, SND compatibility report summary, official-style recovery threshold/too-early promotion, combat-resolution, target-candidate, expression-context, state-transition, animation-controller, or kinematic-controller cuts.
