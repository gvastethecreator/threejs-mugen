...
export type RuntimeEffectSpawnControllerDispatchOptions<TActor extends RuntimeEffectSpawnActor> = {
  ...
  resolveProjectileHitPriority?: RuntimeProjectileSpawnInput["resolveHitPriority"];
  resolveProjectileHitCount?: RuntimeProjectileSpawnInput["resolveHitCount"];
  ...
  resolveProjectilePosture?: RuntimeProjectileSpawnInput["resolvePosture"];
  resolveProjectileLethal?: RuntimeProjectileSpawnInput["resolveLethal"];
...
export class RuntimeEffectSpawnWorld {
  ...
  spawnProjectile(
    ...
    resolveHitPriority?: RuntimeProjectileSpawnInput["resolveHitPriority"],
    resolveHitCount?: RuntimeProjectileSpawnInput["resolveHitCount"],
    ...
    resolvePosture?: RuntimeProjectileSpawnInput["resolvePosture"],
    resolveLethal?: RuntimeProjectileSpawnInput["resolveLethal"],
  ): boolean {
    const owner = effectSpriteOwner(fighter);
  ...
  switch (effect) {
    ...
    case "projectile":
      return effectSpawnWorld.spawnProjectile(
        ...
        options.resolveProjectileHitPriority,
        options.resolveProjectileHitCount,
        ...
        options.resolveProjectilePosture,
        options.resolveProjectileLethal,
      )
        ? 1
        : 0;
