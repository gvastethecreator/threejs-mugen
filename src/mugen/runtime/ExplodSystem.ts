    ...
    .map((explod): ActorSnapshot | undefined => {
      ...
      return {
        ...
        effect: {
          ...
          id: explod.explodId,
          age: explod.age,
          removeTime: explod.removeTime,
          spritePriority: explod.spritePriority,
          opacity: explod.opacity,
          scale: { ...explod.scale },
          removeOnGetHit: explod.removeOnGetHit,
          ignoreHitPause: explod.ignoreHitPause,
          pauseMoveTime: explod.pauseMoveTime,
