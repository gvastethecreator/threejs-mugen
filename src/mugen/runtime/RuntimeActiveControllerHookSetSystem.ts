...
export type RuntimeActiveControllerHookSetInput<TActor extends RuntimeActiveStateDispatchActor> = {
  ...
  modifyReversalDef: NonNullable<RuntimeActiveSideEffectDispatchHooks<TActor>["modifyReversalDef"]>;
  ...
  allPalFx: NonNullable<RuntimeActiveSideEffectDispatchHooks<TActor>["allPalFx"]>;
  ...
  create<TActor extends RuntimeActiveStateDispatchActor>(
    ...
    return {
      ...
      sideEffectHooks: {
        ...
        modifyReversalDef: input.modifyReversalDef,
