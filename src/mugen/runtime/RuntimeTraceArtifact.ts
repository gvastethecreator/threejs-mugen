...
export type RuntimeTraceArtifactFrameSummary = {
  ...
  teamRoundResourceBanks?: RuntimeTraceFrame["teamRoundResourceBanks"];
  teamRoundRedLifeShare?: RuntimeTraceFrame["teamRoundRedLifeShare"];
...
function summarizeArtifactFrame(frame: RuntimeTraceFrame, previous: RuntimeTraceFrame | undefined): RuntimeTraceArtifactFrameSummary {
  return {
    ...
    teamRoundResourceBanks: frame.teamRoundResourceBanks ? structuredClone(frame.teamRoundResourceBanks) : undefined,
    teamRoundRedLifeShare: frame.teamRoundRedLifeShare ? structuredClone(frame.teamRoundRedLifeShare) : undefined,
...
function cloneGateRequirements(gate: RuntimeTraceGate): RuntimeTraceArtifactGateRequirements {
  return {
    ...
    requiredTickSchedulePhaseSequences: gate.requiredTickSchedulePhaseSequences?.map((sequence) => ({
      ...sequence,
