...
import {
  ...
  resolveRuntimeHelperProjectileGroundVelocity,
  resolveRuntimeHelperProjectileDistanceVector,
  resolveRuntimeHelperProjectileGuardVelocity,
  resolveRuntimeHelperProjectileAirVelocity,
  resolveRuntimeHelperProjectileDownVelocity,
  resolveRuntimeHelperProjectileAirGuardVelocity,
  resolveRuntimeHelperProjectileEnvShake,
  resolveRuntimeHelperProjectileFallEnvShake,
  resolveRuntimeHelperProjectileFallImpact,
  resolveRuntimeHelperProjectileFallRecovery,
  resolveRuntimeHelperProjectileFallFlags,
...
export function spawnRuntimeHelperProjectileActor(
  ...
  return spawnRuntimeProjectileActor(store, helper.ownerId, {
    ...
    resolveEnvShake: () => resolveRuntimeHelperProjectileEnvShake(helper, controller, options),
    resolveFallEnvShake: () => resolveRuntimeHelperProjectileFallEnvShake(helper, controller, options),
    resolveFallImpact: () => resolveRuntimeHelperProjectileFallImpact(helper, controller, options),
    resolveFallRecovery: () => resolveRuntimeHelperProjectileFallRecovery(helper, controller, options),
    resolveFallFlags: () => resolveRuntimeHelperProjectileFallFlags(helper, controller, options),
    resolveGroundVelocity: () => resolveRuntimeHelperProjectileGroundVelocity(helper, controller, options),
    resolveMinDistance: () => resolveRuntimeHelperProjectileDistanceVector(helper, controller, "mindist", options),
    resolveMaxDistance: () => resolveRuntimeHelperProjectileDistanceVector(helper, controller, "maxdist", options),
    resolveGuardVelocity: () => resolveRuntimeHelperProjectileGuardVelocity(helper, controller, options),
    ...
    resolvePriority: () => resolveRuntimeHelperIntegerScalarParam(helper, controller, "projpriority", options),
    resolveHitPriority: () => resolveRuntimeHelperIntegerScalarParam(helper, controller, "priority", options),
    resolveHitCount: () => resolveRuntimeHelperIntegerScalarParam(helper, controller, "projhits", options),
    ...
    resolveP1StateNo: () => resolveRuntimeHelperIntegerScalarParam(helper, controller, "p1stateno", options),
    ...
    resolveLethal: (key) => resolveRuntimeHelperFloatScalarParam(helper, controller, key, options),
  });
}
