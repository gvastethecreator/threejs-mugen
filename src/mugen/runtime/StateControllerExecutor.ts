...
function applyAssertSpecialController(
  ...
  for (const flag of flags) {
    ...
    if (flag.name === "noguardpointsdamage") current.noGuardPointsDamage = true;
    if (flag.name === "noredlifedamage") current.noRedLifeDamage = true;
    ...
    if (flag.name === "nofallcount") current.noFallCount = true;
    if (flag.name === "nofallhitflag") current.noFallHitFlag = true;
