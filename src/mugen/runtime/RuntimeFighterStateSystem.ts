...
import { runtimeDizzyPointsMaxFromConstants, runtimeGuardPointsMaxFromConstants, runtimeLifeMaxFromConstants, runtimePowerMaxFromConstants } from "./RuntimeResourceSystem";
import type {
...
export class RuntimeFighterStateWorld {
  create(input: RuntimeFighterStateCreateInput): FighterMatchState {
    ...
    const dizzyPointsMax = runtimeDizzyPointsMaxFromConstants(input.definition.constants);
