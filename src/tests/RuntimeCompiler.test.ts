...
`).commands[0];
  ...
  it("classifies supported and unsupported trigger expressions before runtime evaluation", () => {
    ...
    const p2Metrics = compileExpression("NumEnemy && Facing = 1 && P2Facing = -1 && P2Life > 0 && P2Power >= 0 && PrevStateType = A && PrevMoveType = A");
    ...
    expect(p2Metrics.identifiers).toEqual(["Facing", "NumEnemy", "P2Facing", "P2Life", "P2Power", "PrevMoveType", "PrevStateType"]);
