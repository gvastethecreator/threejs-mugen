...
Recovery-input coverage now includes the positive synthetic `5050 -> 5210 -> 0` route, the required synthetic ground-recovery `5050 -> 5200 -> 5201 -> 52 -> 0` route with velocity telemetry, optional official KFM air/ground positive routes, and synthetic plus optional official KFM negative too-early routes where the command is detected but recovery states are forbidden while `fall.recovertime` remains positive.
