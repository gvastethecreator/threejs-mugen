...
Synthetic recovery-input coverage now includes both the positive `5050 -> 5210 -> 0` route and a negative too-early route where the command is detected but `5210` is forbidden while `fall.recovertime` remains positive.
