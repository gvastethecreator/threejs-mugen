...
- [Define Studio editor authoring spine](tickets/003-studio-editor-authoring-spine.md) - active: bounded identity history, dirty-navigation protection, debounced autosave, project-index v0->v1 migration, and same-origin revision conflict rejection have proof; conflict actions, deeper authoring contracts, filesystem persistence, and source writes remain open.
