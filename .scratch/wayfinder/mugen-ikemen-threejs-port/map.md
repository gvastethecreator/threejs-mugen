...
- [Choose next runtime gap after helper Projectile normal-hit sound typed audio](tickets/012-next-runtime-gap-after-helper-projectile-normal-hit-sound-audio.md)
...
- Exact next runtime gap after helper-parented/root-owned `Projectile` normal-hit GetHitVar sound typed audio telemetry.
