...
- [Define Studio editor authoring spine](tickets/003-studio-editor-authoring-spine.md) - active: bounded identity history, dirty-navigation protection, debounced autosave, and project-index v0->v1 migration have proof; deeper authoring contracts, cross-tab conflicts, filesystem persistence, and source writes remain open.
