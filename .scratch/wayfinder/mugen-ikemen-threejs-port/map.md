...
- [Define Studio editor authoring spine](tickets/003-studio-editor-authoring-spine.md) - active: bounded identity edit history, dirty-navigation protection, and debounced local autosave have browser proof; deeper authoring contracts, filesystem conflicts, migrations, and source writes remain open.
