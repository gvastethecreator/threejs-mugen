...
Still blocked: exact common/player SND archive lookup, channel priority, timing, mixing, panning semantics, super-background audio, helper/redirect ownership, helper Projectile normal-hit contact sound operation telemetry, score movement, and full audio parity. Bounded direct HitDef contact sound operation telemetry was closed later by ticket 008, player-owned Projectile contact sound by ticket 009, and helper Projectile guard sound by ticket 010.
