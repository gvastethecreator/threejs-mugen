# T338 - TargetDizzyPointsAdd guards and absolute value

Status: resolved at bounded TargetDizzyPointsAdd scope
Date: 2026-07-20
...
that are already dizzy or have `NoDizzyPointsDamage`.
...
- A receiver at zero dizzy points and a receiver with `NoDizzyPointsDamage`
  keep their resource unchanged.
...
This covers TargetDizzyPointsAdd resource behavior. WinType cause attribution,
