...
- Next recommended gate: exact recovery thresholds/velocities beyond the current synthetic plus official KFM too-early reject windows, broader `AssertSpecial` priority/KFM confirmation/pause layering, or a narrower raw-controller family promotion to required trace evidence.
