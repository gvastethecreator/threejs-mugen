...
async function main() {
  ...
  const presets = runtime;
    ...
    artifacts.push({
      name: "synthetic-imported-resource-auxiliary-redirect",
      required: true,
      artifact: presets.createSyntheticImportedResourceAuxiliaryRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-resource-auxiliary-state-entry-redirect",
      required: true,
      artifact: presets.createSyntheticImportedResourceAuxiliaryStateEntryRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-control-redirect",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-target-life-redirect",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-target-life-state-entry-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetLifeStateEntryRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-velocity-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetVelocityRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-velocity-state-entry-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetVelocityStateEntryRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-facing-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetFacingRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-facing-state-entry-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetFacingStateEntryRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-drop-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetDropRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-drop-state-entry-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetDropStateEntryRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-bind-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetBindRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-bind-state-entry-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetBindStateEntryRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-state-redirect",
      required: true,
      artifact: presets.createSyntheticImportedTargetStateRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-target-state-state-entry-redirect",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-dizzy-state",
      required: true,
      artifact: presets.createSyntheticImportedDizzyStateTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-envshake-long-finite",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-playerid-root-roster",
      required: true,
      artifact: presets.createSyntheticImportedPlayerIdRootRosterTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-projectile-attack-dizzypoints-snapshot",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-helper-projectile-attack-redlife-snapshot",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileAttackRedLifeSnapshotTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-attack-redlife-guard",
      required: true,
      artifact: presets.createSyntheticImportedProjectileAttackRedLifeGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-attack-redlife-guard",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileAttackRedLifeGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyprojectile-attack-redlife-guard",
      required: true,
      artifact: presets.createSyntheticImportedModifyProjectileAttackRedLifeGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyprojectile-attack-redlife-hit",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-attack-redlife-guard",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileAttackRedLifeGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-getpower-hit",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileGetPowerHitTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-givepower-hit",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-getpower-guard",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileGetPowerGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-damage-guard",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileDamageGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-guard-velocity",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileGuardVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-guard-velocity-yz",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileGuardVelocityYZTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-airguard-velocity",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-airguard-velocity-z",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileAirGuardVelocityZTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-projectile-envshake-long-finite",
      required: true,
      artifact: presets.createSyntheticImportedProjectileEnvShakeLongFiniteTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-envshake",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicEnvShakeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-fall-envshake",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicFallEnvShakeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-fall-impact",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicFallImpactTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-fall-recovery",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicFallRecoveryTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-fall-flags",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-envshake",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicEnvShakeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-fall-envshake",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-fall-recovery",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicFallRecoveryTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-fall-flags",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicFallFlagsTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-forcenofall",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicFallFlagsTraceArtifact({}, true),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-hitdef-dynamic-guardpoints",
      required: true,
      artifact: presets.createSyntheticImportedHitDefDynamicGuardPointsTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-pausetime",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-guard-velocity-yz",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicGuardVelocityYZTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-projectile-keepstate-release",
      required: true,
      artifact: presets.createSyntheticImportedProjectileKeepStateReleaseTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-projectile-airguard-velocity-derived-z",
      required: true,
      artifact: presets.createSyntheticImportedProjectileAirGuardVelocityDerivedZTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-airguard-velocity",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-guard-velocity",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicGuardVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-down-velocity",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicDownVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-guard-hittime",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicGuardHitTimeTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-helper-projectile-keepstate-release",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileKeepStateReleaseTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-helper-projectile-airguard-velocity-derived-z",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-down-velocity",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicDownVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-down-velocity",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileDownVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-ground-velocity",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileGroundVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-air-velocity",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileAirVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-air-velocity-broadcast",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileAirVelocityBroadcastTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-air-velocity-index",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileAirVelocityIndexTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-down-velocity-index",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileDownVelocityIndexTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-ground-velocity-index",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileGroundVelocityIndexTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-guard-velocity-index",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyProjectileGuardVelocityIndexTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyprojectile-airguard-velocity-index",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-direct-air-velocity-physical",
      required: true,
      artifact: presets.createSyntheticImportedDirectAirVelocityPhysicalTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-dynamic-direct-air-velocity",
      required: true,
      artifact: presets.createSyntheticImportedDynamicDirectAirVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-air-velocity",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicAirVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-dynamic-direct-down-velocity",
      required: true,
      artifact: presets.createSyntheticImportedDynamicDirectDownVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-dynamic-direct-down-hittime",
      required: true,
      artifact: presets.createSyntheticImportedDynamicDirectDownHitTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-down-hittime",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicDownHitTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-down-hittime",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicDownHitTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-ground-hittime",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicGroundHitTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-ground-hittime",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicGroundHitTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-ground-slidetime",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicGroundSlideTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-ground-slidetime",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicGroundSlideTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-air-hittime",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicAirHitTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-air-hittime",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-removetime",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicRemoveTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-removetime",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicRemoveTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-misstime",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicMissTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-misstime",
      required: true,
      artifact: presets.createSyntheticImportedHelperProjectileDynamicMissTimeTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-projectile-dynamic-priority",
      required: true,
      artifact: presets.createSyntheticImportedProjectileDynamicPriorityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-projectile-dynamic-priority",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-sparkangle",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicSparkAngleTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-guard-sparkangle",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicGuardSparkAngleTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-guard-sparkno",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-guardsound-channel",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicGuardSoundChannelTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-hitsound",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicHitSoundTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-hitsound-channel",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicHitSoundChannelTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-transformclsn-angle",
      required: true,
      artifact: presets.createSyntheticImportedTransformClsnAngleTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-envshake-diradd-decay",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-envcolor-indefinite",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-ikemen-helper-playerpush-redirect",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-ikemen-root-overrideclsn-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootOverrideClsnRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-nothitby-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootNotHitByRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-hitoverride-redirect",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-ikemen-root-hitdef-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootHitDefRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyhitdef-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyHitDefRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyhitdef-sprite-priority-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyHitDefSpritePriorityRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyhitdef-priority-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyHitDefPriorityRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyhitdef-kill-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyHitDefKillRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyhitdef-guard-kill-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyHitDefGuardKillRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyhitdef-fall-kill-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyHitDefFallKillRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyhitdef-hitonce-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyHitDefHitOnceRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-direct-air-juggle",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-ikemen-helper-projectile-air-juggle",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-ikemen-reversaldef-p1facing",
      required: true,
      artifact: presets.createSyntheticImportedIkemenReversalDefP1FacingTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyreversaldef-dynamic-state",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyReversalDefDynamicStateTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyreversaldef-dynamic-attack-depth",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyReversalDefDynamicAttackDepthTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyreversaldef-dynamic-id",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyReversalDefDynamicIdTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyreversaldef-p2state-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyReversalDefP2StateRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyreversaldef-p2owner-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyReversalDefP2OwnerRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyreversaldef-guardflag-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyReversalDefGuardFlagRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyreversaldef-guardflag-not-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyReversalDefGuardFlagNotRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyreversaldef-sprite-priority-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyReversalDefSpritePriorityRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-root-modifyreversaldef-missonoverride-redirect",
      required: true,
      artifact: presets.createSyntheticImportedIkemenRootModifyReversalDefMissOnOverrideRedirectTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-ikemen-active-root-direct-guard",
      required: true,
      artifact: presets.createSyntheticImportedIkemenActiveRootDirectGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-active-root-crouch-guard",
      required: true,
      artifact: presets.createSyntheticImportedIkemenActiveRootCrouchGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-active-root-crouch-high-guard-reject",
      required: true,
      artifact: presets.createSyntheticImportedIkemenActiveRootCrouchHighGuardRejectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-active-root-crouch-low-guard",
      required: true,
      artifact: presets.createSyntheticImportedIkemenActiveRootCrouchLowGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-active-root-standing-low-guard-reject",
      required: true,
      artifact: presets.createSyntheticImportedIkemenActiveRootStandingLowGuardRejectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-active-root-standing-high-guard",
      required: true,
      artifact: presets.createSyntheticImportedIkemenActiveRootStandingHighGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-active-root-air-guard",
      required: true,
      artifact: presets.createSyntheticImportedIkemenActiveRootAirGuardTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-active-root-air-guard-landing",
      required: true,
      artifact: presets.createSyntheticImportedIkemenActiveRootAirGuardLandingTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-hitdef-dynamic-airguard-velocity",
      required: true,
      artifact: presets.createSyntheticImportedHitDefDynamicAirGuardVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-hitdef-dynamic-airguard-velocity-z",
      required: true,
      artifact: presets.createSyntheticImportedHitDefDynamicAirGuardVelocityZTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-airguard-velocity",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicAirGuardVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-airguard-cornerpush",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicAirGuardCornerPushTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyhitdef-dynamic-ground-cornerpush",
      required: true,
      artifact: presets.createSyntheticImportedModifyHitDefDynamicGroundCornerPushTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-airguard-velocity-derived-z",
      required: true,
      artifact: presets.createSyntheticImportedAirGuardVelocityDerivedZTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-ikemen-stage-depth-bound",
      required: true,
      artifact: presets.createSyntheticImportedIkemenStageDepthBoundTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-depth-controller",
      required: true,
      artifact: presets.createSyntheticImportedIkemenDepthControllerTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-ikemen-screen-stagebound",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-ikemen-playerpush-policy",
      required: true,
      artifact: presets.createSyntheticImportedIkemenPlayerPushPolicyTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-modifyprojectile-dynamic-state",
      required: true,
      artifact: presets.createSyntheticImportedModifyProjectileDynamicStateTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-modifyprojectile-dynamic-guard-velocity",
      required: true,
      artifact: presets.createSyntheticImportedModifyProjectileDynamicGuardVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyprojectile-dynamic-ground-velocity",
      required: true,
      artifact: presets.createSyntheticImportedModifyProjectileDynamicGroundVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-modifyprojectile-dynamic-air-velocity",
      required: true,
      artifact: presets.createSyntheticImportedModifyProjectileDynamicAirVelocityTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-helper-modifyhitdef-dynamic-down-velocity",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyHitDefDynamicDownVelocityTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-modifyhitdef-dynamic-down-hittime",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyHitDefDynamicDownHitTimeTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-helper-modifyhitdef-dynamic-guard-velocity-yz",
      required: true,
      artifact: presets.createSyntheticImportedHelperModifyHitDefDynamicGuardVelocityYZTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-helper-bind-to-target-redirect",
      required: true,
      artifact: presets.createSyntheticImportedHelperBindToTargetRedirectTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-helper-target-state-redirect",
      required: true,
      artifact: presets.createSyntheticImportedHelperTargetStateRedirectTraceArtifact(),
    });
    artifacts.push({
      name: "synthetic-imported-helper-target-helper-redirect",
      required: true,
    ...
    artifacts.push({
      name: "synthetic-imported-helper-target-auxiliary-redirect",
      required: true,
      artifact: presets.createSyntheticImportedHelperTargetAuxiliaryResourceHelperRedirectTraceArtifact(),
    });
    artifacts.push({
    ...
    artifacts.push({
      name: "synthetic-imported-helpervar",
      required: true,
      artifact: presets.createSyntheticImportedHelperVarTraceArtifact(),
    });
    artifacts.push({
        ...
        artifact: presets.createImportedQcfXTraceArtifact(imported, {
          ...
          requiredFinalActors: [
            ...
            },
            {
              ...
              moveType: "H",
              physics: "S",
              hitFall: { falling: true, velocityY: -3.5, downRecover: true },
            },
          ],
    ...
    if (fs.existsSync(codeFuManFixturePath)) {
      ...
      artifacts.push({
        name: "codefuman-independent-upper-x",
        required: false,
        artifact: presets.createCodeFuManIndependentUpperXTraceArtifact(imported),
      });
    } else {
      skipped.push({
...
function validateTraceCoverage(coverage) {
  ...
  const requiredArtifactNames = [
    ...
    "synthetic-imported-helper-target-state-redirect",
    ...
    "synthetic-imported-projectile-keepstate-release",
    ...
    "synthetic-imported-helper-projectile-keepstate-release",
    ...
    "synthetic-imported-helper-projectile-dynamic-down-velocity",
    "synthetic-imported-helper-modifyprojectile-down-velocity",
    "synthetic-imported-helper-modifyprojectile-ground-velocity",
    "synthetic-imported-helper-modifyprojectile-air-velocity",
    "synthetic-imported-helper-modifyprojectile-air-velocity-broadcast",
    "synthetic-imported-helper-modifyprojectile-air-velocity-index",
    "synthetic-imported-helper-modifyprojectile-down-velocity-index",
