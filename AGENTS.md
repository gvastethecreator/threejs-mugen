...
- Immediate next slice after the target-owned custom-state gate: R1 Common1/FightFX precision or R2 MatchWorld ownership, whichever can produce focused evidence without broad drift.
