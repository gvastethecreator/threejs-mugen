...
- Immediate next slice after the synthetic guard-hit actor-frame gate: R1 Common1/FightFX precision or R2 MatchWorld ownership, whichever can produce focused evidence without broad drift.
